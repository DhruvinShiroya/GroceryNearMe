...
namespace GroceryNearMe.Controllers
{
    ...
    public class StoresController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Stores.Include(s => s.Address).Include(s => s.CompanyName);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,AddressId,CompanyId")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,AddressId,CompanyId")] Store store)
        {
            if (id != store.Id)
            {
                return NotFound();
